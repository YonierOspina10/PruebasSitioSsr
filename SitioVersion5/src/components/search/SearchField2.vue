...
<template>
    ...
    >
        ...
        <button 
            ...
            :data-analytics-context="`component:SearchField2|layout:layout-${appComponent.config.layout}`" 
            @click="toggleInput"
        >
            <IconLupa
        ...
        >
            ...
            <input
                ...
                class="rounded-full border-[2px] border-input-border text-neutral absolute bottom-1 transform right-[2px] h-[30px] bg-input-background"
            />
        </div>
    </div>
    ...
    <div
        ...
        id="search-input-two"
        class="w-full bg-input-background border-[2px] border-input-border absolute z-[60] top-20 right-[35px] md:right-[320px] transition-all duration-300 ease-out p-2"
        :style="{
    ...
    >
        <div class="rounded-lg shadow-lg flex-1 overflow-auto p-1">
            ...
            >
                ...
                <div class="flex flex-col justify-center items-center gap-4 w-full h-full p-2 break-all">
                    ...
                    <button
                        class="bg-success text-neutral text-sm w-40 rounded-full font-bold p-2 uppercase hover:scale-105"
