...
export default defineComponent({
	...
	props: {
		...
		width: Number, // Width of the SVG element, expected to be a Number
		height: Number, // Height of the SVG element, expected to be a Number
	},
});
</script>
...
<template>
	...
	>
		<!-- Path element defining the shape of the SVG -->
		<path
