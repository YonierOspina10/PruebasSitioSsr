...
import EyesIcon from '../icons/EyesIcon2.vue'; // Import EyeIcon component
import EyesCloseIcon from '../icons/EyesCloseIcon.vue'; // Import EyeIcon component
import { useModalStore } from '../../stores/Modal';
import ExitIconModalEcuabet from '../../../../SitioVersion5/src/components/icons/ExitIconModalEcuabet.vue';
import EmailIcon from '../icons/EmailIcon.vue';
import PadLockIcon from '../icons/PadLockIcon.vue'; // Import modal store for modal management

export default defineComponent({
    components: {
          PadLockIcon, EyesIcon, EmailIcon, ExitIconModalEcuabet,
          ...
          EyesCloseIcon, // Register EyesCloseIcon component
      },
    data(){
                ...
                apiService
                    ...
                    .then((response: any) => {
                        ...
                        if (response.code == 0) {
                            ...
                            this.modals.closeModal('ModalLoginV3');
                            this.modals.addModal({
                                showModal: 'ModalUpdatePassword', // Showing password update modal
                                orderModal: 'closeModal',
                            });
    ...
    <div class="fixed inset-0 z-[101] flex items-center justify-center bg-base-content bg-opacity-50">
        <div class="bg-base-content/10 backdrop-blur-md rounded-2xl shadow-xl w-full md:w-[98%] max-w-[931px] h-full md:h-[95%] lg:max-h-[579px] border-0 sm:border-2 border-primary-focus flex item-center justify-between
            ...
            <div class="flex flex-col md:flex-row justify-start md:justify-center items-start md:items-center w-full">
                ...
                <!-- Banner -->
                <div class="w-full h-[216px] md:h-[96%] lg:h-[531px] bg-cover rounded-t-2xl hidden sm:flex justify-center items-center flex-col gap-4 sm:gap-8">
                    <img alt="" :src="bannerImageD" class="hidden sm:block h-[216px] md:h-[90%] lg:h-[531px] w-full md:w-[90%]">
                </div>

                <div
                    class="w-full h-[316px] md:h-[531px] bg-cover bg-center rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none sm:hidden block"
                    :style="{ backgroundImage: `url(${bannerImageM})` }"
                ></div>

                <!-- Login Form -->
                <div v-if="!viewToken" class="w-full p-6 md:p-4 lg:p-8 flex flex-col justify-center sm:border-t-0 border-t-1 border-primary-content rounded-t-xl">
                    <div class="w-full hidden  sm:flex flex-col items-center gap-5 md:gap-4 lg:gap-12">
                        ...
                        />
                        <div class="leading-2">
                            <p class="text-3xl md:text-xl lg:text-3xl font-semibold text-center mb-0 md:mb-0 lg:mb-4 text-neutral">
                                {{$t('Bienvenido')}}
                    ...
                    <div class="w-full flex flex-col mt-3 md:mt-0 lg:mt-6 md:gap-2 lg:gap-8">
                        <Form :validation-schema="schema" @submit="onSubmit" v-slot="{ errors }">
                            <div class="mb-4 md:mb-1 lg:mb-8">
                                ...
                                <div class="w-full px-0 sm:px-4 py-2 bg-transparent sm:bg-base-content/10 border-transparent border-b-1 border-b-primary flex relative backdrop-blur-md rounded-t-md">
                            ...
                            <div class="mb-4 md:mb-1 lg:mb-6">
                                ...
                                <div class="w-full px-0 sm:px-4 py-2 bg-transparent sm:bg-base-content/10 border-transparent border-b-1 border-b-primary flex relative backdrop-blur-md rounded-t-md">
                                    ...
                                    <button
                                        type="button"
                                        class="absolute top-4 sm:top-5 right-6"
                                        id="showpass"
                                        @click="showpass()"
                                    >
                                        <EyesIcon v-if="show" class="w-6 h-6 fill-accent-focus"/>
                                        <EyesCloseIcon v-if="!show" class="w-6 h-6 fill-accent-focus stroke-accent-focus"/>
                                    </button>
                                </div>
                                <div
                ...
                <div v-else-if="viewToken" class="w-full p-6 md:p-4 lg:p-8 flex flex-col justify-center sm:border-t-0 border-t-1 border-primary-content rounded-t-xl">
